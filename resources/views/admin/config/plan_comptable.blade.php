...
<body>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-4 text-end d-flex flex-column gap-2 border-start border-white/10 ps-6">
                                    <div class="d-flex gap-2">
                                        ...
                                        <button type="button" class="btn btn-danger rounded-xl px-4 py-3" title="Annuler / Vider le plan" data-bs-toggle="modal" data-bs-target="#modalConfirmResetPlan">
                                                ...
                                                <div class="btn-group">
                                                    <button class="btn btn-icon btn-sm btn-outline-primary border-0 rounded-circle" onclick="editAccount({{ $plan->id }}, '{{ $plan->numero_de_compte }}', '{{ addslashes($plan->intitule) }}')" title="Modifier"><i class="fa-solid fa-pen-to-square"></i></button>
                                                     <button type="button" class="btn btn-icon btn-sm btn-outline-danger border-0 rounded-circle" 
                                                         ...
                                                         data-name="{{ $plan->numero_de_compte }} - {{ $plan->intitule }}"
                                                         data-url="{{ route('admin.config.delete_account', $plan->id) }}">
                                                         <i class="fa-solid fa-trash-can"></i>
                                                     </button>
                                                </div>
                                            </td>
    ...
    <div class="modal fade" id="modalConfirmResetPlan" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-content premium-modal-content">
                ...
                <div class="text-center mb-6 position-relative">
                    ...
                    <h1 class="text-xl font-extrabold tracking-tight text-slate-900">
                        Vider le <span class="text-red-600">Plan Comptable</span>
                    </h1>
                </div>

                <div class="text-center space-y-3 mb-8">
                    <p class="text-slate-500 text-sm font-medium leading-relaxed">
                        Êtes-vous sûr de vouloir vider tout le plan comptable master ? Les comptes liés à des écritures comptables seront conservés pour préserver l'intégrité de vos données.
                    </p>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <form action="{{ route('admin.config.reset_plan') }}" method="POST" class="w-full">
                        @csrf
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content premium-modal-content">
                ...
                <div class="text-center space-y-3 mb-8">
                    ...
                    <div id="accountToDeleteName" class="text-slate-900 font-bold"></div>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <form id="deleteAccountForm" method="POST" action="" class="w-full">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="btn-save-premium !bg-red-600 hover:!bg-red-700 shadow-red-200">
                            Supprimer
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (deleteModal) {
                deleteModal.addEventListener('show.bs.modal', function(event) {
                    ...
                    const modalName = deleteModal.querySelector('#accountToDeleteName');
                    const modalForm = deleteModal.querySelector('#deleteAccountForm');
