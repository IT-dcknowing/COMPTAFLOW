...
Route::middleware(['auth', 'exercice.context'])->group(function () {
    ...
    Route::get('/reporting/tft-personalized', [ReportingController::class, 'tftPersonalized'])->name('reporting.tft_personalized');
    Route::get('/reporting/tft-personalized/export', [ReportingController::class, 'exportPersonalizedTFT'])->name('reporting.tft_personalized.export');
...
Route::get('/dashboard-compta', [ComptaDashboardController::class, 'index'])->name('compta.dashboard')->middleware(['auth']);
    ...
    Route::prefix('admin')->name('admin.')->group(function() {
        ...
        Route::get('/import/export-existing/{id}', [App\Http\Controllers\Admin\AdminConfigController::class, 'exportExisting'])->name('import.export_existing');
