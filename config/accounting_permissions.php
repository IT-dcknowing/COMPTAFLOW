...
return [
    ...
    'permissions' => [
        ...
        'Opérations (Super Admin)' => [
            'superadmin.accounting.index' => 'Comptabilités (Super Admin)',
            'superadmin.tasks.index' => 'Tâches (Super Admin)',
        ...
        'Gouvernance' => [
            ...
            'compagny_information' => 'Fiche Entreprise',
        ...
        'Traitement' => [
            ...
            'plan_tiers' => 'Hub des Tiers',
            'plan_comptable' => 'Hub du Plan Comptable',
            'accounting_journals' => 'Hub des Journaux',
            'ecriture.rejected' => 'Écritures rejetées',
            'brouillons.index' => 'Brouillons',
            'exercice_comptable' => 'Exercice comptable',
            'compta.create' => 'Ouvrir un exercice comptable',
